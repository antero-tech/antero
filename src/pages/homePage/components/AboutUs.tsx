...
const aboutUsDetails = [
  ...
  },
  {
    ...
    subheading1: 'Lorem Ipsum',
    copy1:
      'We believe that effective communication and meeting deadlines are crucial elements of successful application development. We prioritize open and transparent communication with our clients throughout the entire process, ensuring that their vision is understood and incorporated into every aspect of the development journey.',
    subheading2: 'Lorem Ipsum',
    copy2:
      'Our dedicated team works closely with clients, providing regular updates, gathering feedback, and addressing any concerns promptly. With our strong commitment to timely delivery, we meticulously plan and manage our development process to meet agreed-upon deadlines. Trust us to not only deliver exceptional applications but also maintain clear communication channels to keep you informed and involved every step of the way.',
